...
# RESOURCES
# (1) Config — https://ret2pop.net/config/qutebrowser.html
# (2) Cheatsheet — https://chipsenkbeil.com/notes/qutebrowser-cheatsheet/
...
#---------
# Debug
config.bind(',dk', 'debug-keytester') # See key inputs
...
# could also handle ui like this:
...
config.bind(',k', 'tab-focus stack-prev')
